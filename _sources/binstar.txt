...
#. Clone the ``conda-prescriptions`` repo from https://github.com/NSLS-II/conda-prescriptions
#. init a binstar build if one doesn't exist already ::

   binstar-build init

#. Edit the binstar-build file ``.binstar.yml`` so that it basically looks like this ::
